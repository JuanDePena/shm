...
ssl_listen_template="${repo_root}/packaging/httpd/simplehost-ssl-listen.conf"
http_template="${repo_root}/packaging/httpd/simplehost-control-http.conf.template"
https_template="${repo_root}/packaging/httpd/simplehost-control-https.conf.template"
httpd_conf="/etc/httpd/conf.d/simplehost-control.conf"
httpd_ssl_listen_conf="/etc/httpd/conf.d/00-simplehost-ssl-listen.conf"
