...
- `combined release-root cutover handoff`: source-level consolidated handoff artifact over the actual cutover layer, still below deploy/release promotion because the real `current` root remains untouched
- `combined release-root cutover rehearsal`: source-level consolidated rehearsal artifact over the actual cutover layer, still below deploy/release promotion because the real `current` root remains untouched
- `combined release-root cutover parity`: source-level consolidated parity artifact over the actual cutover layer, still below deploy/release promotion because the real `current` root remains untouched
- `combined release-root cutover gate`: source-level consolidated gate artifact over the actual cutover layer, still below deploy/release promotion because the real `current` root remains untouched
...
- `combined release-root cutover ready`: source-level readiness report for that emulated actual release root, still below deploy/release promotion because the real `current` root remains untouched
- `combined release-root cutover rehearsal`: source-level cutover -> ready -> rollback cycle on that emulated actual release root, still below deploy/release promotion because the real `current` root remains untouched
- `combined release-root cutover parity`: source-level proof that the real cutover plan and the emulated target rehearsal stay aligned, still below deploy/release promotion because the real `current` root remains untouched
- `combined release-root cutover handoff`: source-level consolidated handoff artifact over that emulated actual release root, still below deploy/release promotion because the real `current` root remains untouched
