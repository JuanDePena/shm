...
export interface DashboardCopyLabels {
  ...
  repositoriesWorkspaceDescription: string;
  ...
  accountsWorkspaceDescription: string;
  ...
  selinuxWorkspaceDescription: string;
...
function getObjectViewLabel(
  ...
  switch (view) {
    ...
    case "repositories":
      return copy.navRepositories;
    case "reboots":
      return copy.navReboots;
    case "config":
...
export function getDashboardSubheading(copy: DashboardCopyLabels, view: DashboardView): string {
  switch (view) {
    ...
    case "repositories":
      return copy.repositoriesWorkspaceDescription;
    case "reboots":
      return copy.rebootsWorkspaceDescription;
    case "config":
    ...
    case "accounts":
      return copy.accountsWorkspaceDescription;
    case "services":
    ...
    case "selinux":
      return copy.selinuxWorkspaceDescription;
    case "ssh":
      return copy.sshWorkspaceDescription;
    case "packages":
    ...
    case "reconciliation":
      return copy.reconciliationWorkspaceDescription;
    default:
      break;
  }
